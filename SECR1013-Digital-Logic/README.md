...
**Instructor:** Mr. Ahmad Fariz Bin Ali  
**Section:** 02  
...
| **2** | Number Systems & Coding Schemes |
| **3** | Logic Gates |
| **4** | Boolean Algebra & Logic Simplification |
| **5** | Combinational Logic Circuits |
| **6** | Applications of Combinational Logic |
...
**"Understanding the hardware gives meaning to the software."**
